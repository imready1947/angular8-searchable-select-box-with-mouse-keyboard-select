import { Component, OnInit, Input, ViewChild, ViewChildren, ElementRef, forwardRef, HostListener, QueryList, Output, EventEmitter, ChangeDetectionStrategy, OnDestroy } from '@angular/core';
...
export class SelectDropdownComponent implements ControlValueAccessor, OnInit {
  ...
  @Input() setStyleObject: Object; // = {'width':'250px', 'background-color':'red'}
  @Input() setClassToDropdown: string;
  @Input() setClassToSelectedBox: string;
  ...
  ngOnInit() {
    this._list.subscribe((list) => {
      this.items = list;
      console.log("in ngoninit -- " + this.value);
...
// https://stackoverflow.com/questions/28482128/how-to-show-red-border-at-invalid-input-box-after-clicking-submit-button-with-an
